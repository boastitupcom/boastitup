...
// Mock brand ID for demo - replace with actual brand selection logic
const DEMO_BRAND_ID = 'd96060ac-48b6-447f-9161-9d7f8619cdfa';

const InstagramAnalysisPage = () => {
  const [dateRange, setDateRange] = useState('30d');
  const { analysis, posts, hashtags, trends, loading, error, refreshData } = useInstagramAnalysis(DEMO_BRAND_ID, dateRange);
    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          ...
          <p className="text-gray-500">No Instagram analysis data found for this brand.</p>
        </div>
      </div>
    );
  }
          ...
          <div className="flex items-center justify-between py-4">
            <div>
              ...
              <p className="text-sm text-gray-500">
                Comprehensive insights for @{analysis.instagram_handle}
              </p>
            </div>
